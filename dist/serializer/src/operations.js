...
var uint8 = _types2.default.uint8,
    ...
    indexed_optional = _types2.default.indexed_optional,
...
var fba_distribute_operation_fee_parameters = (exports.fba_distribute_operation_fee_parameters = new Serializer(
    "fba_distribute_operation_fee_parameters"
));

var bid_collateral_operation_fee_parameters = (exports.bid_collateral_operation_fee_parameters = new Serializer(
...
var execute_bid_operation_fee_parameters = (exports.execute_bid_operation_fee_parameters = new Serializer(
    "execute_bid_operation_fee_parameters"
));

var asset_claim_pool_operation_fee_parameters = (exports.asset_claim_pool_operation_fee_parameters = new Serializer(
...
var asset_update_issuer_operation_fee_parameters = (exports.asset_update_issuer_operation_fee_parameters = new Serializer(
...
var call_order_update_options = (exports.call_order_update_options = new Serializer(
...
var fba_distribute = (exports.fba_distribute = new Serializer(
    "fba_distribute",
    {
        fee: asset,
        account_id: protocol_id_type("account"),
...
var bid_collateral = (exports.bid_collateral = new Serializer(
    "bid_collateral",
    {
        fee: asset,
...
var asset_claim_pool = (exports.asset_claim_pool = new Serializer(
    "asset_claim_pool",
    {
        fee: asset,
        issuer: protocol_id_type("account"),
...
var asset_update_issuer = (exports.asset_update_issuer = new Serializer(
    "asset_update_issuer",
    {
        fee: asset,
        issuer: protocol_id_type("account"),
